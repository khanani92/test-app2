  ...
  private <T> Map<String, T> listByIds(
    ...
    try {
      ...
      if (idGetter != null) {
        ...
        com.muddassir.runtime.security.UserSecurityContext securityContextPrincipal =
            (com.muddassir.runtime.security.UserSecurityContext) securityContext.getPrincipal();
